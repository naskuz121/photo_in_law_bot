...
guide_message = """Ти щойно завантажив безкоштовний гайд — отже, вже зробив перший крок до впевненості у своїх правах.
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == '📥 Отримати гайд':
        ...
        await update.message.reply_text(
            """Привіт, фотограф!
Пропоную одразу скачати абсолютно безкоштовний гайд, який вже зараз захистить твої роботи!"""
        )
        await update.message.reply_text(guide_message, reply_markup=keyboard_more)
    elif text == '🔥 Хочу!':
